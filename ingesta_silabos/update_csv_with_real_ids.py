...
def update_csv_with_real_ids(input_dir="ingesta_silabos/resultados_csv"):
...
if __name__ == "__main__":
    ...
    print("📁 Check ingesta_silabos/resultados_csv/ for the updated *_SIS.csv, *_SOFT.csv, *_IND.csv files.")
