...
Separación de proveedores del proyecto:
    ...
    EMBEDDINGS Y ETIQUETADO DE TEXTO                -> OpenAI, OPEN_AI_INGEST_API_KEY
...
El chatbot va por Groq y no por Claude porque es conversación de alto volumen y
bajo valor por mensaje (navegación, cultura general): su free tier absorbe ese
tráfico sin tocar el saldo prepago que sostiene evaluaciones y tutor RAG.
...
MODELO_VISION_GEMINI = os.getenv("GEMINI_VISION_MODEL", "gemini-2.5-flash")
